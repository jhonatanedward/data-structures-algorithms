...
public class MinimumBinaryTreeDepth {
    ...
    public static int teste(TreeNode root) {
        ...
        Stack<problems.trees.utils.Pair> stack = new Stack();
        stack.add(new problems.trees.utils.Pair(root, 1));
        int ans = Integer.MAX_VALUE;

        while(!stack.isEmpty()) {
            problems.trees.utils.Pair currentPair = stack.pop();
            ...
            if(currNode.left != null) {
                stack.add(new problems.trees.utils.Pair(currNode.left, depth + 1));
            }
            if(currNode.right != null) {
                stack.add(new problems.trees.utils.Pair(currNode.right, depth + 1));
            }
        }
